...
- **Movie Correlation Project.ipynb:** contains a data analysis and cleaning conducted with Python. Supoortive data was retrieved from https://www.kaggle.com/danielgrijalvas/movies. **Jupyter Notebook** were used as a platform. 
